 ...
 */
final class Version20190716065728 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE employe (id INT AUTO_INCREMENT NOT NULL, service_id INT NOT NULL, matricule VARCHAR(255) NOT NULL, nomcomplet VARCHAR(255) NOT NULL, datenaiss DATE NOT NULL, salaire INT NOT NULL, INDEX IDX_F804D3B9ED5CA9E6 (service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
